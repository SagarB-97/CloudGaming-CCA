...
/*
 * TCP Low Priority 2 (TCP-LP2)
 *
 * TCP Low Priority 2 is a distributed algorithm whose goal is to utilize only
...
MODULE_AUTHOR("Shawn Chen, Sagar Bharadwaj");
MODULE_LICENSE("GPL");
MODULE_DESCRIPTION("TCP Low Priority 2");
